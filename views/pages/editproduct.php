...
<form action="/products/update?id=<?=$id?>" method="post" enctype="multipart/form-data">
<div class="card">
<div class="card-body">
<div class="row">
...
<input name ="product_name" type="text" value = "<?=$prod_name?>">
</div>
</div>
<div class="col-lg-3 col-sm-6 col-12">
<div class="form-group">
...
<a href="/products/prodlist" class="btn btn-cancel">Cancel</a>
</div>
</div>
</div>
</div>
